...
linked_systems:
  ...
  - "lib/shipglows/presentation/widgets/dashboard_projection_panel.dart"
  - "test/shipglows/data/dashboard_readonly_projection_repository_test.dart"
  - "test/shipglows/presentation/widgets/dashboard_projection_panel_test.dart"
depends_on:
...
evidence:
  ...
  - "flutter test test/shipglows/presentation/widgets/dashboard_projection_panel_test.dart"
  - "flutter test test/data/firestore_projection test/shipglows"
  - "flutter analyze lib/shipglows test/shipglows"
...
# Verification Report - ShipGlows Dashboard Read-only Projection
...
- `flutter test test/shipglows/data/dashboard_readonly_projection_repository_test.dart` passed.
- `flutter test test/shipglows/presentation/widgets/dashboard_projection_panel_test.dart` passed.
- `flutter test test/data/firestore_projection test/shipglows` passed.
- `flutter analyze lib/shipglows test/shipglows` passed.
