...
scope: "shipglows-product-entitlements-compliance"
owner: "Diane"
confidence: high
risk_level: high
security_impact: yes
...
linked_systems:
  ...
  - "support runbook"
depends_on:
  - artifact: "shipglows_data/workflow/specs/shipglows-product-entitlements-compliance.md"
...
evidence:
  ...
  - "flutter analyze"
  - "python3 /home/claude/shipglowz/tools/shipglows_metadata_lint.py selected ShipGlows artifacts"
next_review: "2026-06-30"
next_step: "/sf-ship ShipGlows Product Entitlements Compliance verification trace"
---

# Verification: ShipGlows Product Entitlements Compliance
...
| `ENT-PRODUCT-001` | `product_id=shipglows_app`. | PASS: constant and tests use `shipglows_app`. |
...
flutter test test/data/models/app_entitlement_test.dart test/core/app_access_resume_test.dart test/core/offline_sync_test.dart test/navigation/resume_no_jump_test.dart
flutter analyze
python3 /home/claude/shipglowz/tools/shipglows_metadata_lint.py shipglows_data/technical/product-entitlements.md shipglows_data/technical/product-entitlement-bridge-contract.md shipglows_data/technical/product-entitlements-support-runbook.md shipglows_data/workflow/verification/shipglows-product-entitlements-compliance.md shipglows_data/workflow/specs/shipglows-product-entitlements-compliance.md
```
...
Post-ship production deployment `dpl_491rXUVf8JMBvUiU5PNFC95q5mMi` is `Ready`, commit `1e835bb` has successful GitHub status, and `https://shipglowsapp.vercel.app/` returned HTTP 200 with ShipGlows and `flutter_bootstrap.js` markers on 2026-05-30 20:59:30 UTC.

Chromium headless proof on 2026-05-30 21:01:09 UTC rendered the Flutter UI instead of a gray page. Visible state: sidebar with ShipGlows, Overview, Diagnostics, Settings; header `ShipGlows Operations Dashboard`; main panel message `No projects found in PROJECTS.md.` Screenshot evidence: `/tmp/shipglowsapp-prod-sf-browser.png`. DOM proof included `main.dart.js`, `flutter_bootstrap.js`, `flutter-view`, and title `ShipGlows Operations Dashboard`.
