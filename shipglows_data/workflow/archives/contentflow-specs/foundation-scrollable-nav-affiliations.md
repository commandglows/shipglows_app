...
🟢 [contentflow_app] spec: Fondation — Navigation scrollable + Affiliations (domaine pilote) | status: ready | path: shipglows_data/workflow/archives/contentflow-specs/foundation-scrollable-nav-affiliations.md | next: /sf-docs audit shipglows_data/workflow/archives/contentflow-specs/foundation-scrollable-nav-affiliations.md
