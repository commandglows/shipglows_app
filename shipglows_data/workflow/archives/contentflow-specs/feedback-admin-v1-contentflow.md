...
🟢 [contentflow_app] spec: Feedback Admin v1 pour ContentFlow | status: ready | path: shipglows_data/workflow/archives/contentflow-specs/feedback-admin-v1-contentflow.md | next: /sf-docs audit shipglows_data/workflow/archives/contentflow-specs/feedback-admin-v1-contentflow.md
