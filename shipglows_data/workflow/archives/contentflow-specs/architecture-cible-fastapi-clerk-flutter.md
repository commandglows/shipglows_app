...
🟢 [contentflow_app] spec: Architecture cible propre — Astro + Flutter + FastAPI + Clerk | status: ready | path: shipglows_data/workflow/archives/contentflow-specs/architecture-cible-fastapi-clerk-flutter.md | next: /sf-docs audit shipglows_data/workflow/archives/contentflow-specs/architecture-cible-fastapi-clerk-flutter.md
...
- [ ] Tache 15: Retirer Next.js du runtime une fois la parite atteinte
  - Fichier: shipglows_data d'exploitation / infra
