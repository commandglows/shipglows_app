...
depends_on:
  ...
  - "shipglows_data/business/branding.md@1.0.0"
  - "shipglows_data/technical/guidelines.md@1.0.0"
supersedes: []
target_segment:
  - creators
  - solopreneurs
...
## Proof points (supported in code/shipglows_data)
...
- **"Can I publish everywhere today?"**
  - Partial answer: publish-related screens and settings exist, but the complete account-mapping and external publish feedback loop is still marked incomplete in current shipglows_data/workflow/specs.
...
- **"Can this break existing channels?"**
  - Route and auth behavior are centralized; integration changes should be validated through shipglows_data/workflow/specs and shipglows_data before changes are promoted.
