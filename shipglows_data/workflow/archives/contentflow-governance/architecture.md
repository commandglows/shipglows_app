...
depends_on:
  ...
  - artifact: "shipglows_data/workflow/archives/contentflow-specs/architecture-cible-fastapi-clerk-flutter.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipglows_data/workflow/archives/contentflow-specs/SPEC-offline-sync-v2.md"
    artifact_version: "0.1.0"
    required_status: "draft"
supersedes: []
linked_systems:
...
next_step: "/sf-docs update shipglows_data/technical/architecture.md"
---

# shipglows_data/technical/architecture.md — contentflow_app (Flutter + FastAPI + Clerk)
...
- Changing queue semantics has high risk and requires synchronized spec + shipglows_data + provider updates.
