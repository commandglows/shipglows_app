...
evidence:
  ...
  - "shipglows_data/workflow/archives/contentflow-specs/SPEC-project-flows-selection-onboarding-archive.md"
...
- Any change to onboarding, publish behavior, or offline coverage changes this product promise and must trigger shipglows_data updates for user-facing claims.
