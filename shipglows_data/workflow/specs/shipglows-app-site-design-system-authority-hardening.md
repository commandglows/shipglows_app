...
owner: "Diane"
confidence: medium
user_story: "En tant qu'utilisatrice ShipGlows, je veux que l'application Flutter et le site marketing partagent un contrat de design strict pour éviter tout quick-fix visuel, conserver une image pro, et rendre impossible la customisation hors tokens centralisés."
risk_level: "high"
...
next_step: "/sf-ready shipglows-app-site design-system authority hardening"
---
# Spec: shipglows_app – App & Site Design-System Authority Hardening

# Title

shipglows_app – App & Site Design-System Authority Hardening

## Status

Draft for execution planning. This spec defines non-negotiable design rules before any further UI edits are accepted for `shipglows_app`.

## User Story

En tant qu'utilisatrice ShipGlows, je veux que les interfaces site et app restent sur un style systematique, cohérent, et professionnel, de sorte qu'aucun agent ni développeur ne puisse appliquer des modifications visuelles adhoc sans passer par les tokens centralisés.
...
- Document any cross-surface exception (app-only or site-only) in `shipglows_data/technical/design-system-authority.md` before merging.
...
- `shipglows_data/technical/design-system-authority.md` and related workflow specs.
...
1. **Formal declaration extension**
   - Keep `shipglows_data/technical/design-system-authority.md` as the canonical contract.
...
python3 /home/claude/shipglowz/tools/shipglows_metadata_lint.py shipglows_data/technical/design-system-authority.md shipglows_data/workflow/specs/shipglows-app-site-design-system-authority-hardening.md shipglows_data/workflow/verification/shipglows-app-site-design-system-authority-hardening.md
```
...
- `web_auth` assets are legacy and intentionally excluded from this hardening scope unless they become user-facing ShipGlows UX.
...
- [ ] Update `shipglows_data/technical/design-system-authority.md` with explicit mapping and exception list for app/site.
