...
docs_impact: "yes"
depends_on:
  - artifact: "shipglows_data/workflow/specs/SPEC-migrate-flutter-core-majors.md"
...
🟡 [contentflow_app] spec: Migrate Flutter Core Majors Baseline | status: active | path: shipglows_data/workflow/specs/migrate-flutter-core-majors-baseline.md | next: /sf-start Migrate Flutter Core Majors: Riverpod, GoRouter, Google Fonts, Riverpod Codegen
...
- `pubspec.lock`
- `pubspec.yaml`
- `shipglows_data/workflow/archives/contentflow-specs/PRD-lifetime-deal-early-bird-payg.md`
- `shipglows_data/workflow/archives/contentflow-specs/SPEC-content-pipeline-unification.md`
- `shipglows_data/workflow/archives/contentflow-specs/SPEC-offline-sync-v2.md`
- `shipglows_data/workflow/archives/contentflow-specs/architecture-cible-fastapi-clerk-flutter.md`
- `shipglows_data/workflow/archives/contentflow-specs/feedback-admin-v1-contentflow.md`
- `shipglows_data/workflow/archives/contentflow-specs/feedback-backend-contract-fastapi.md`
- `shipglows_data/workflow/archives/contentflow-specs/foundation-scrollable-nav-affiliations.md`
- `shipglows_data/workflow/archives/contentflow-specs/late-integration-finalization.md`
- `shipglows_data/workflow/archives/contentflow-specs/spec-no-ui-jump-on-resume.md`

Untracked files/directories observed:

- `.fvmrc`
- `.github/`
- `shipglows_data/workflow/specs/SPEC-migrate-flutter-core-majors.md`
...
- `shipglows_data/workflow/specs/SPEC-migrate-flutter-core-majors.md`
- `shipglows_data/workflow/specs/migrate-flutter-core-majors-baseline.md`
...
7. Full gate and shipglows_data:
   - Expected files: shipglows_data only after validation proves final package majors and Turso/no-backend conclusion.
