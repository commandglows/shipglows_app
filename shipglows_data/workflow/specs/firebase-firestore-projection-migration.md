...
owner: "Diane"
confidence: medium
user_story: "En tant que fondatrice de ShipGlows, je veux traduire le WIP Supabase retrouve en architecture Firebase/Firestore, afin de garder les contrats utiles sans adopter Supabase comme stack cible."
risk_level: "high"
security_impact: "yes"
docs_impact: "yes"
linked_systems:
  - "backup/local-supabase-wip-2026-05-08"
  - "shipglows_data/workflow/specs/full-supabase-migration.md"
  - "Firebase Auth"
  - "Cloud Firestore"
...
depends_on:
  ...
  - artifact: "shipglows_data/technical/shipglows-foundational-architecture.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "https://firebase.google.com/shipglows_data/flutter/setup"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  - artifact: "https://firebase.google.com/shipglows_data/auth/flutter/start"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  - artifact: "https://firebase.google.com/shipglows_data/firestore"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  ...
  - artifact: "https://firebase.google.com/shipglows_data/functions"
    ...
    required_status: "active"
supersedes:
  - "backup/local-supabase-wip-2026-05-08:shipglows_data/workflow/specs/full-supabase-migration.md as implementation target"
evidence:
  ...
  - "User decision 2026-05-09: clone is mandatory, internal, managed by ShipGlows infrastructure, and V1 is read-only."
...
🟢 [shipglows_app] spec: Firebase Firestore Projection Migration | status: ready | path: shipglows_data/workflow/specs/firebase-firestore-projection-migration.md | next: /sf-start Firebase Firestore projection migration
...
En tant que fondatrice de ShipGlows, je veux traduire le WIP Supabase retrouve en architecture Firebase/Firestore, afin de garder les contrats utiles sans adopter Supabase comme stack cible.
...
- Given a ShipGlows project, the canonical identity is GitHub `owner/repo`.
...
- If Firebase shipglows_data or SDK behavior differ from assumptions, implementation stops and updates this spec.
...
- Update shipglows_data to record translation decisions.
...
- Official Firebase Flutter setup shipglows_data checked 2026-05-09: `https://firebase.google.com/shipglows_data/flutter/setup`.
- Official Firebase Auth Flutter shipglows_data checked 2026-05-09: `https://firebase.google.com/shipglows_data/auth/flutter/start`.
- Official Cloud Firestore shipglows_data checked 2026-05-09: `https://firebase.google.com/shipglows_data/firestore`.
- Official Firestore Security Rules shipglows_data checked 2026-05-09: `https://firebase.google.com/shipglows_data/firestore/security/get-started`.
- Official Cloud Functions for Firebase shipglows_data checked 2026-05-09: `https://firebase.google.com/shipglows_data/functions`.
- Local evidence: `backup/local-supabase-wip-2026-05-08:shipglows_data/workflow/specs/full-supabase-migration.md`.
...
- `shipglows_data/workflow/specs/shipglows-project-source-onboarding.md` becomes the immediate feature spec that consumes this architecture.
- `shipglows_data/technical/recovered-branch-reality.md` remains the durable memory for branch and WIP context.
- `shipglows_data/technical/markdown-source-of-truth.md` must mention Firestore as projection once implementation starts.
- Future Firebase implementation must update `pubspec.yaml`, app init, auth/session providers, projection repositories, and shipglows_data.
...
- Keep `shipglows_data/technical/recovered-branch-reality.md` as source for branch reality.
- Future implementation shipglows_data must distinguish `GitHub canonical`, `local clone working copy`, and `Firestore projection`.
...
1. Create a Supabase-to-Firebase contract extraction document under `shipglows_data/technical/`.
...
6. Update `shipglows_data/technical/recovered-branch-reality.md` with recovered contract checklist.
7. Update `shipglows_data/workflow/specs/shipglows-project-source-onboarding.md` to consume Firebase/Firestore architecture.
...
- Documentation validation:
  - `rg -n "Supabase|Firebase|Firestore|Cloud Functions|GitHub repository|local clone" shipglows_data/workflow/specs shipglows_data/technical README.md`
  - `rg -n "recovered-branch-reality|firebase-firestore-projection-migration" shipglows_data/editorial/content-map.md shipglows_data/technical shipglows_data/workflow/specs`
...
- Fresh external shipglows_data checked from official Firebase shipglows_data on 2026-05-09.
...
| 2026-05-09 13:00:00 UTC | sf-start | GPT-5 Codex | implemented | Added `shipglows_data/technical/supabase-to-firebase-contract-map.md`. |
...
| Step | Status | Notes |
| --- | --- | --- |
| sf-spec | done | Spec created in `shipglows_data/workflow/specs/firebase-firestore-projection-migration.md`. |
| sf-ready | ready | Ready for documentation extraction slice. |
| governance corpus gate | already existed | `shipglows_data/technical/`, `shipglows_data/technical/code-docs-map.md`, and `shipglows_data/editorial/content-map.md` exist. |
| sf-start | implemented | Extraction doc created in `shipglows_data/technical/supabase-to-firebase-contract-map.md`. |
