...
evidence:
  ...
  - "shipglows_data/workflow/specs/shipglows-product-entitlements-compliance.md"
next_review: "2026-06-10"
next_step: "/sf-verify ShipGlows Firestore Data Model"
---
...
- Product access rule:
  - identity and membership are insufficient without server-owned product access for `product_id=shipglows_app`
...
```json
{
  "fileId": "specs_shipglows-firestore-data-model_md",
  "path": "shipglows_data/workflow/specs/shipglows-firestore-data-model.md",
  "artifactType": "spec",
  "sourceCommit": "abc123",
  "contentHash": "sha256:...",
...
```json
{
  ...
  "redactedPath": "shipglows_data/workflow/specs/large-file.md"
}
```
...
```bash
rg -n "users/\\{uid\\}|projects/\\{projectId\\}|indexedFiles|indexRuns|diagnostics|projectRefs|feedItems|suiteAccess|shipglows_app|grantsAccess" shipglows_data/technical/firestore-data-model.md
flutter test test/data/firestore_projection
rg -n "token|installation token|service credential|clone path|clone URL" shipglows_data/technical/firestore-data-model.md lib/data/firestore_projection test/data/firestore_projection
```
