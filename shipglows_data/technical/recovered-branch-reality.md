...
depends_on:
  ...
  - "shipglows_data/technical/shipglows-legacy-reuse-roadmap.md@0.1.0"
supersedes: []
evidence:
...
- `shipglows_data/technical/recovered-branch-reality.md`
- `shipglows_data/workflow/specs/shipglows-project-source-onboarding.md`
- future Firebase/Firestore migration shipglows_data/workflow/specs
...
- A ShipGlows project is necessarily a GitHub repository.
...
- Future Firebase/Firestore shipglows_data/workflow/specs must use current official docs before implementation.
...
- Tests and acceptance criteria from `shipglows_data/workflow/specs/full-supabase-migration.md`.
...
git show --stat backup/local-supabase-wip-2026-05-08
git grep -n "Supabase\\|Firestore\\|Firebase\\|GitHub" backup/local-supabase-wip-2026-05-08 -- shipglows_data/workflow/specs lib supabase test
```
