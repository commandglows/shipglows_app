...
docs_impact: yes
linked_systems:
  - "backup/local-supabase-wip-2026-05-08:shipglows_data/workflow/specs/full-supabase-migration.md"
  - "Firebase Auth"
  - "Cloud Firestore"
  ...
  - "local clones"
depends_on:
  - "shipglows_data/workflow/specs/firebase-firestore-projection-migration.md@0.1.0"
...
next_step: "/sf-start ShipGlows Project Source Onboarding"
---
...
- `shipglows_data/technical/supabase-to-firebase-contract-map.md`
