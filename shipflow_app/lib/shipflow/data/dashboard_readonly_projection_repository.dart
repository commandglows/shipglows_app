...
class InMemoryDashboardReadonlyProjectionRepository
  ...
  InMemoryDashboardReadonlyProjectionRepository({
    ...
    required Map<String, ShipFlowProjectRecord> projects,
  ...
  final Map<String, ShipFlowProjectRecord> _projects;
  ...
  DashboardArtifactFamily _familyFor(IndexedFileRecord file) {
    ...
    if (path.startsWith('shipflow_data/business/')) {
      return DashboardArtifactFamily.business;
    }
    if (path.startsWith('shipflow_data/technical/')) {
      return DashboardArtifactFamily.technical;
    }
    if (path.startsWith('shipflow_data/editorial/')) {
      return DashboardArtifactFamily.editorial;
    }
    if (path.startsWith('shipflow_data/workflow/specs/')) {
      return DashboardArtifactFamily.spec;
    }
    if (path.startsWith('shipflow_data/workflow/bugs/')) {
      return DashboardArtifactFamily.bug;
    }
    if (path.startsWith('shipflow_data/workflow/')) {
