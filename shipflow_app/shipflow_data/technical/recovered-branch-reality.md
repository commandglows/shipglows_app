...
depends_on:
  ...
  - "shipflow_data/technical/shipflow-legacy-reuse-roadmap.md@0.1.0"
supersedes: []
evidence:
...
- `shipflow_data/technical/recovered-branch-reality.md`
- `shipflow_data/workflow/specs/shipflow-project-source-onboarding.md`
- future Firebase/Firestore migration shipflow_data/workflow/specs
...
- Future Firebase/Firestore shipflow_data/workflow/specs must use current official docs before implementation.
...
- Tests and acceptance criteria from `shipflow_data/workflow/specs/full-supabase-migration.md`.
...
git show --stat backup/local-supabase-wip-2026-05-08
git grep -n "Supabase\\|Firestore\\|Firebase\\|GitHub" backup/local-supabase-wip-2026-05-08 -- shipflow_data/workflow/specs lib supabase test
```
