...
linked_systems:
  ...
  - "/home/claude/shipflow/shipflow_data/business/branding.md"
  - "/home/claude/shipflow/shipflow_data/technical/design-system-authority.md"
depends_on:
  - artifact: "/home/claude/shipflow/shipflow_data/business/branding.md"
    artifact_version: "1.0.0"
...
For `shipflow_app`, design authority is declared in two parts:

- **Brand contract**: `/home/claude/shipflow/shipflow_data/business/branding.md`
- **Surface carriers**:
...
design_system_authority:
  status: declared
  brand_contract: /home/claude/shipflow/shipflow_data/business/branding.md
  technology_carriers:
    - site/src/styles/global.css
    - app/lib/presentation/theme/app_theme.dart
  canonical_source: /home/claude/shipflow/shipflow_data/technical/design-system-authority.md
  mandatory_scope:
    - color
    - typography
    - spacing
    ...
    - motion
  validation:
    - python3 /home/claude/shipflow/tools/design_system_drift_check.py --root /home/claude/shipflow_app/app --warn-only --format markdown
    - python3 /home/claude/shipflow/tools/design_system_drift_check.py --root /home/claude/shipflow_app/site --warn-only --format markdown
  forbidden_bypass:
...
If this surface adds a shared token source (e.g. DTCG JSON, shared theme package), update this artifact and `shipflow_data/technical/code-docs-map.md` before implementing UI changes.
