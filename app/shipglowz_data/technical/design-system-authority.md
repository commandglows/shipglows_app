...
linked_systems:
  ...
  - "/home/claude/shipglowz/shipglowz_data/business/branding.md"
  - "/home/claude/shipglowz/shipglowz_data/technical/design-system-authority.md"
depends_on:
  - artifact: "/home/claude/shipglowz/shipglowz_data/business/branding.md"
    artifact_version: "1.0.0"
...
next_step: "/sf-docs update shipglowz_data/technical/design-system-authority.md"
---
...
For `shipglowz_app`, design authority is declared in two parts:

- **Brand contract**: `/home/claude/shipglowz/shipglowz_data/business/branding.md`
- **Surface carriers**:
...
design_system_authority:
  status: declared
  brand_contract: /home/claude/shipglowz/shipglowz_data/business/branding.md
  technology_carriers:
    - site/src/styles/global.css
    - app/lib/presentation/theme/app_theme.dart
  canonical_source: /home/claude/shipglowz/shipglowz_data/technical/design-system-authority.md
  mandatory_scope:
    - color
    - typography
    - spacing
...
If this surface adds a shared token source (e.g. DTCG JSON, shared theme package), update this artifact and `shipglowz_data/technical/code-docs-map.md` before implementing UI changes.
