...
depends_on:
  ...
  - "shipglowz_data/technical/shipglowz-legacy-reuse-roadmap.md@0.1.0"
supersedes: []
evidence:
...
- `shipglowz_data/technical/recovered-branch-reality.md`
- `shipglowz_data/workflow/specs/shipglowz-project-source-onboarding.md`
- future Firebase/Firestore migration shipglowz_data/workflow/specs
...
- A ShipGlowz project is necessarily a GitHub repository.
...
- Future Firebase/Firestore shipglowz_data/workflow/specs must use current official docs before implementation.
...
- Tests and acceptance criteria from `shipglowz_data/workflow/specs/full-supabase-migration.md`.
...
git show --stat backup/local-supabase-wip-2026-05-08
git grep -n "Supabase\\|Firestore\\|Firebase\\|GitHub" backup/local-supabase-wip-2026-05-08 -- shipglowz_data/workflow/specs lib supabase test
```
