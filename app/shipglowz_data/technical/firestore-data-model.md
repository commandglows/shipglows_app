...
evidence:
  ...
  - "shipglowz_data/workflow/specs/shipglowz-product-entitlements-compliance.md"
next_review: "2026-06-10"
next_step: "/sf-verify ShipGlowz Firestore Data Model"
---
...
- Product access rule:
  - identity and membership are insufficient without server-owned product access for `product_id=shipglowz_app`
...
```json
{
  "fileId": "specs_shipglowz-firestore-data-model_md",
  "path": "shipglowz_data/workflow/specs/shipglowz-firestore-data-model.md",
  "artifactType": "spec",
  "sourceCommit": "abc123",
  "contentHash": "sha256:...",
...
```json
{
  ...
  "redactedPath": "shipglowz_data/workflow/specs/large-file.md"
}
```
...
```bash
rg -n "users/\\{uid\\}|projects/\\{projectId\\}|indexedFiles|indexRuns|diagnostics|projectRefs|feedItems|suiteAccess|shipglowz_app|grantsAccess" shipglowz_data/technical/firestore-data-model.md
flutter test test/data/firestore_projection
rg -n "token|installation token|service credential|clone path|clone URL" shipglowz_data/technical/firestore-data-model.md lib/data/firestore_projection test/data/firestore_projection
```
