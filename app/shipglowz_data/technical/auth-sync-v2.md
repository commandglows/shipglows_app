...
status: draft
source_skill: manual
scope: shipglowz-app-v2-auth-sync
owner: unknown
confidence: medium
risk_level: high
security_impact: yes
...
supersedes: []
evidence:
  - "Existing V2 auth and sync decision note migrated into shipglowz_data/technical."
next_review: "2026-06-27"
next_step: "/sf-docs audit shipglowz_data/technical/auth-sync-v2.md"
---

# ShipGlowz App V2 Auth + Sync (Decision Note)
