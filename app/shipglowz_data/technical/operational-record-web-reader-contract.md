...
linked_systems:
  ...
  - "test/data/shipglowz_sources/parsers/operational_record_parser_test.dart"
...
Define the normalized read-model contract for rendering operational records in future ShipGlowz web surfaces from Markdown sources, without introducing a second parser behavior. Migration output must be readable by this model directly.
