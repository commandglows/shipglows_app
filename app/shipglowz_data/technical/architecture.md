...
depends_on:
  ...
  - artifact: "shipglowz_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipglowz_data/workflow/specs/SPEC-offline-sync-v2.md"
    artifact_version: "0.1.0"
    required_status: "draft"
supersedes: []
linked_systems:
...
next_step: "/sf-docs update shipglowz_data/technical/architecture.md"
---

# shipglowz_data/technical/architecture.md — contentflow_app (Flutter + FastAPI + Clerk)
...
- Changing queue semantics has high risk and requires synchronized spec + shipglowz_data + provider updates.
