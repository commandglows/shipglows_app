...
depends_on:
  ...
  - "shipglowz_data/business/branding.md@1.0.0"
  - "shipglowz_data/technical/guidelines.md@1.0.0"
supersedes: []
target_segment:
  - creators
  - solopreneurs
...
next_step: "/sf-docs audit shipglowz_data/business/gtm.md"
---
...
## Proof points (supported in code/shipglowz_data)
...
- **"Can I publish everywhere today?"**
  - Partial answer: publish-related screens and settings exist, but the complete account-mapping and external publish feedback loop is still marked incomplete in current shipglowz_data/workflow/specs.
...
- **"Can this break existing channels?"**
  - Route and auth behavior are centralized; integration changes should be validated through shipglowz_data/workflow/specs and shipglowz_data before changes are promoted.
