...
Aujourd’hui, ShipGlowz est déjà un cockpit opérationnel en lecture seule :
...
Le point d’entrée le confirme dans [`main.dart`](/home/claude/shipglowz_app/app/lib/main.dart), et les routes actives sont dans [`shipglowz/router.dart`](/home/claude/shipglowz_app/app/lib/shipglowz/router.dart).
...
2. Spécifier la frontière sécurisée du « ShipGlowz Agent Runner ».
