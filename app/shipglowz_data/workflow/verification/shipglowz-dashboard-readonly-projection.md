...
linked_systems:
  ...
  - "lib/shipglowz/data/dashboard_readonly_projection_repository.dart"
  - "lib/shipglowz/presentation/widgets/dashboard_projection_panel.dart"
  - "test/shipglowz/data/dashboard_readonly_projection_repository_test.dart"
  - "test/shipglowz/presentation/widgets/dashboard_projection_panel_test.dart"
depends_on:
...
supersedes: []
evidence:
  - "flutter test test/shipglowz/data/dashboard_readonly_projection_repository_test.dart"
  - "flutter test test/shipglowz/presentation/widgets/dashboard_projection_panel_test.dart"
  - "flutter test test/data/firestore_projection test/shipglowz"
  - "flutter analyze lib/shipglowz test/shipglowz"
...
next_step: "/sf-verify ShipGlowz Dashboard Read-only Projection"
---

# Verification Report - ShipGlowz Dashboard Read-only Projection
...
- `flutter test test/shipglowz/data/dashboard_readonly_projection_repository_test.dart` passed.
- `flutter test test/shipglowz/presentation/widgets/dashboard_projection_panel_test.dart` passed.
- `flutter test test/data/firestore_projection test/shipglowz` passed.
- `flutter analyze lib/shipglowz test/shipglowz` passed.
