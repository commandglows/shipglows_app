...
scope: "shipglowz-product-entitlements-compliance"
owner: "Diane"
confidence: high
risk_level: high
security_impact: yes
...
linked_systems:
  ...
  - "support runbook"
depends_on:
  - artifact: "shipglowz_data/workflow/specs/shipglowz-product-entitlements-compliance.md"
...
evidence:
  ...
  - "flutter analyze"
  - "python3 /home/claude/shipglowz/tools/shipglowz_metadata_lint.py selected ShipGlowz artifacts"
next_review: "2026-06-30"
next_step: "/sf-ship ShipGlowz Product Entitlements Compliance verification trace"
---

# Verification: ShipGlowz Product Entitlements Compliance
...
| `ENT-PRODUCT-001` | `product_id=shipglowz_app`. | PASS: constant and tests use `shipglowz_app`. |
...
flutter test test/data/models/app_entitlement_test.dart test/core/app_access_resume_test.dart test/core/offline_sync_test.dart test/navigation/resume_no_jump_test.dart
flutter analyze
python3 /home/claude/shipglowz/tools/shipglowz_metadata_lint.py shipglowz_data/technical/product-entitlements.md shipglowz_data/technical/product-entitlement-bridge-contract.md shipglowz_data/technical/product-entitlements-support-runbook.md shipglowz_data/workflow/verification/shipglowz-product-entitlements-compliance.md shipglowz_data/workflow/specs/shipglowz-product-entitlements-compliance.md
```
...
Post-ship production deployment `dpl_491rXUVf8JMBvUiU5PNFC95q5mMi` is `Ready`, commit `1e835bb` has successful GitHub status, and `https://shipglowzapp.vercel.app/` returned HTTP 200 with ShipGlowz and `flutter_bootstrap.js` markers on 2026-05-30 20:59:30 UTC.

Chromium headless proof on 2026-05-30 21:01:09 UTC rendered the Flutter UI instead of a gray page. Visible state: sidebar with ShipGlowz, Overview, Diagnostics, Settings; header `ShipGlowz Operations Dashboard`; main panel message `No projects found in PROJECTS.md.` Screenshot evidence: `/tmp/shipglowzapp-prod-sf-browser.png`. DOM proof included `main.dart.js`, `flutter_bootstrap.js`, `flutter-view`, and title `ShipGlowz Operations Dashboard`.
