...
supersedes: []
evidence: []
next_step: "/sf-docs audit shipglowz_data/workflow/specs/PRD-lifetime-deal-early-bird-payg.md"
---
# Spec: Lifetime Deal Early Early Bird (BYOK / Pay-As-You-Go)
🟡 [contentflow_app] spec: Lifetime Deal Early Early Bird (BYOK / Pay-As-You-Go) | status: draft | path: shipglowz_data/workflow/specs/PRD-lifetime-deal-early-bird-payg.md | next: /sf-docs audit shipglowz_data/workflow/specs/PRD-lifetime-deal-early-bird-payg.md
