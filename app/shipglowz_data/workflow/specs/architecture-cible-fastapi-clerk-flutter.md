...
supersedes: []
evidence: []
next_step: "/sf-docs audit shipglowz_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md"
---
# Spec: Architecture cible propre — Astro + Flutter + FastAPI + Clerk
🟢 [contentflow_app] spec: Architecture cible propre — Astro + Flutter + FastAPI + Clerk | status: ready | path: shipglowz_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md | next: /sf-docs audit shipglowz_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md
...
- [ ] Tache 15: Retirer Next.js du runtime une fois la parite atteinte
  - Fichier: shipglowz_data d'exploitation / infra
