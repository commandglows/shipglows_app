...
docs_impact: "yes"
depends_on:
  - artifact: "shipglowz_data/workflow/specs/SPEC-migrate-flutter-core-majors.md"
...
🟡 [contentflow_app] spec: Migrate Flutter Core Majors Baseline | status: active | path: shipglowz_data/workflow/specs/migrate-flutter-core-majors-baseline.md | next: /sf-start Migrate Flutter Core Majors: Riverpod, GoRouter, Google Fonts, Riverpod Codegen
...
- `pubspec.lock`
- `pubspec.yaml`
- `shipglowz_data/workflow/specs/PRD-lifetime-deal-early-bird-payg.md`
- `shipglowz_data/workflow/specs/SPEC-content-pipeline-unification.md`
- `shipglowz_data/workflow/specs/SPEC-offline-sync-v2.md`
- `shipglowz_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md`
- `shipglowz_data/workflow/specs/feedback-admin-v1-contentflow.md`
- `shipglowz_data/workflow/specs/feedback-backend-contract-fastapi.md`
- `shipglowz_data/workflow/specs/foundation-scrollable-nav-affiliations.md`
- `shipglowz_data/workflow/specs/late-integration-finalization.md`
- `shipglowz_data/workflow/specs/spec-no-ui-jump-on-resume.md`

Untracked files/directories observed:

- `.fvmrc`
- `.github/`
- `shipglowz_data/workflow/specs/SPEC-migrate-flutter-core-majors.md`
...
- `shipglowz_data/workflow/specs/SPEC-migrate-flutter-core-majors.md`
- `shipglowz_data/workflow/specs/migrate-flutter-core-majors-baseline.md`
...
7. Full gate and shipglowz_data:
   - Expected files: shipglowz_data only after validation proves final package majors and Turso/no-backend conclusion.
