...
import 'package:shipglows_app/shipglows/data/dashboard_readonly_projection_repository.dart';
    ...
    test(
      ...
      () async {
        ...
        expect(
          ...
          'shipglows_data/workflow/specs/demo.md',
        );
      },
    );
...
InMemoryDashboardReadonlyProjectionRepository _repository() {
  ...
  return InMemoryDashboardReadonlyProjectionRepository(
    ...
    projects: {
      ...
      'proj_private': ShipGlowsProjectRecord(
      ...
      'proj_empty': ShipGlowsProjectRecord(
        projectId: 'proj_empty',
        githubOwner: 'acme',
        githubRepo: 'empty',
    ...
    indexedFiles: [
      IndexedFileRecord(
        fileId: 'proj_a:tasks',
        path: 'shipglows_data/workflow/TASKS.md',
      ...
      IndexedFileRecord(
        ...
        path: 'shipglows_data/technical/architecture.md',
      ...
      IndexedFileRecord(
        fileId: 'proj_a:old',
        path: 'shipglows_data/technical/old.md',
        artifactType: 'technical',
        sourceCommit: 'abcdef1',
