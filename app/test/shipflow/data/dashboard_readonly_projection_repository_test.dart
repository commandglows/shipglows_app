...
import 'package:shipflow_app/shipflow/data/dashboard_readonly_projection_repository.dart';
    ...
    test(
      ...
      () async {
        ...
        expect(
          ...
          'shipflow_data/workflow/specs/demo.md',
        );
      },
    );
...
InMemoryDashboardReadonlyProjectionRepository _repository() {
  ...
  return InMemoryDashboardReadonlyProjectionRepository(
    ...
    projects: {
      ...
      'proj_private': ShipFlowProjectRecord(
      ...
      'proj_empty': ShipFlowProjectRecord(
        projectId: 'proj_empty',
        githubOwner: 'acme',
        githubRepo: 'empty',
    ...
    indexedFiles: [
      IndexedFileRecord(
        fileId: 'proj_a:tasks',
        path: 'shipflow_data/workflow/TASKS.md',
      ...
      IndexedFileRecord(
        ...
        path: 'shipflow_data/technical/architecture.md',
      ...
      IndexedFileRecord(
        fileId: 'proj_a:old',
        path: 'shipflow_data/technical/old.md',
        artifactType: 'technical',
        sourceCommit: 'abcdef1',
