...
import 'package:shipglowz_app/data/shipglowz_sources/parsers/specs_parser.dart';

void main() {
  group('SpecsParser', () {
    test('emits diagnostics for summary conflicts with frontmatter', () {
      const path = 'shipglowz_data/workflow/specs/sample.md';
      const markdown = '''
---
status: ready
---
# Spec: Sample
🟠 [shipglowz_app] spec: Sample | status: draft | path: shipglowz_data/workflow/specs/other.md | next: /sf-start Sample
## Title
Sample
''';
