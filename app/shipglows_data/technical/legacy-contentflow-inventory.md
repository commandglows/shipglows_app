...
| `shipglows_data/workflow/specs/SPEC-offline-sync-v2.md` | ContentFlow | reference-only | medium | Preserve concepts for future sync/projection spec |
| `shipglows_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md` | ContentFlow | reference-only | high | Do not treat FastAPI or Clerk as active ShipGlows decisions |
| `shipglows_data/workflow/specs/feedback-admin-v1-contentflow.md` | ContentFlow | keep-concept | medium | Mine later for text-only feedback spec |
| `shipglows_data/workflow/specs/feedback-backend-contract-fastapi.md` | ContentFlow | reference-only | high | Do not adopt FastAPI feedback backend without new spec |
| `shipglows_data/workflow/specs/SPEC-content-pipeline-unification.md` | ContentFlow | park | medium | User asked not to touch pipeline for now |
| `shipglows_data/workflow/specs/SPEC-project-flows-selection-onboarding-archive.md` | ContentFlow | adapt-candidate | medium | Review later for ShipGlows project/source onboarding |
| `shipglows_data/workflow/specs/spec-no-ui-jump-on-resume.md` | ContentFlow | adapt-candidate | medium | Keep as UX reliability reference |
| `shipglows_data/workflow/specs/foundation-scrollable-nav-affiliations.md` | ContentFlow | park | low | ContentFlow UI/domain reference only |
| `shipglows_data/workflow/specs/late-integration-finalization.md` | ContentFlow | reference-only | medium | Review only if integrations become active ShipGlows scope |
...
| `shipglows_data/workflow/specs/PRD-lifetime-deal-early-bird-payg.md` | ContentFlow business | archive-later | low | Not active ShipGlows product scope |
