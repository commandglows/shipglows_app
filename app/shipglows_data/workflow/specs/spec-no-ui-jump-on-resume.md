...
supersedes: []
evidence: []
next_step: "/sf-docs audit shipglows_data/workflow/specs/spec-no-ui-jump-on-resume.md"
---
# Spec: Stabiliser La Reprise Mobile/Web Sans Mouvement UI
🟢 [contentflow_app] spec: Stabiliser La Reprise Mobile/Web Sans Mouvement UI | status: ready | path: shipglows_data/workflow/specs/spec-no-ui-jump-on-resume.md | next: /sf-docs audit shipglows_data/workflow/specs/spec-no-ui-jump-on-resume.md
