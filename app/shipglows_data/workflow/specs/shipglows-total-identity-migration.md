...
- Checklist path: `app/shipglows_data/workflow/test-checklists/shipglows-total-identity-migration.md`.
...
- [x] Task 1: Produce and approve the complete rename manifest.
  - Files: new governed manifest under `app/shipglows_data/workflow/`, inventories from both repositories and provider read-only exports.
