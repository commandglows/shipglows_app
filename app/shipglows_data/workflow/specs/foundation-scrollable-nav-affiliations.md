...
supersedes: []
evidence: []
next_step: "/sf-docs audit shipglows_data/workflow/specs/foundation-scrollable-nav-affiliations.md"
---
# Spec: Fondation — Navigation scrollable + Affiliations (domaine pilote)
🟢 [contentflow_app] spec: Fondation — Navigation scrollable + Affiliations (domaine pilote) | status: ready | path: shipglows_data/workflow/specs/foundation-scrollable-nav-affiliations.md | next: /sf-docs audit shipglows_data/workflow/specs/foundation-scrollable-nav-affiliations.md
