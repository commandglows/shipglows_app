...
🟢 [contentflow_app] spec: Project Flows: Optional Source URL, Explicit No Selection, Active Project Editing, and Archive-First Deletion | status: ready | path: shipglows_data/workflow/specs/SPEC-project-flows-selection-onboarding-archive.md | next: /sf-start Project flows selection onboarding archive
## Title
...
- Review `contentflow_app/shipglows_data/technical/guidelines.md`, `contentflow_app/README.md`, and settings/onboarding support copy for GitHub-only project language. Update any text that says projects must be GitHub repositories.
