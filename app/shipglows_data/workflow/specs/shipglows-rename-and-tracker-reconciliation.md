...
evidence:
  ...
  - "The active application directory is shipglows_app and its governance corpus is shipglows_app/shipglows_data."
...
- Le monorepo utilise `app/`, `app/shipglows_data/`, `lib/shipglows/` et `lib/data/shipglows_sources/` comme chemins canoniques.
...
- `shipglows_data/` renomme en `shipglows_data/` dans l'application.
...
- Reparer les commandes obsoletes `/home/claude/shipglows_app` et `shipglows_data`.
...
- [x] Task 1: Establish rename inventory and historical compatibility allowlist
  - File: `app/shipglows_data/workflow/specs/shipglows-rename-and-tracker-reconciliation.md`
...
- [x] Task 2: Rename repository paths and Dart package/module identifiers
  - File: `shipglows_app/`, `shipglows_app/shipglows_data/`, `lib/shipglows/`, `lib/data/shipglows_sources/`, `test/shipglows/`
  - Action: Move to `app/`, `shipglows_data/`, `lib/shipglows/`, `lib/data/shipglows_sources/`, and `test/shipglows/`; update imports and scripts.
...
- [x] Task 4: Reconcile trackers and completed specs from durable evidence
  - File: `app/shipglows_data/workflow/TASKS.md`, `app/shipglows_data/workflow/specs/*.md`, `app/shipglows_data/workflow/verification/*.md`
...
- [x] AC 2: Canonical repository paths are `app/` and `app/shipglows_data/`.
