...
supersedes: []
evidence: []
next_step: "/sf-docs audit shipglows_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md"
---
# Spec: Architecture cible propre — Astro + Flutter + FastAPI + Clerk
🟢 [contentflow_app] spec: Architecture cible propre — Astro + Flutter + FastAPI + Clerk | status: ready | path: shipglows_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md | next: /sf-docs audit shipglows_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md
