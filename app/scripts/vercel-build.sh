...
DART_DEFINES="$DART_DEFINES --dart-define=PERSONAL_CLOUD_ENABLED=$PERSONAL_CLOUD_ENABLED_VALUE"
if [[ -n "$MANAGED_RUNNER_BASE_URL_VALUE" ]]; then
  DART_DEFINES="$DART_DEFINES --dart-define=MANAGED_RUNNER_BASE_URL=$MANAGED_RUNNER_BASE_URL_VALUE"
fi
if [[ -n "$FIREBASE_API_KEY_VALUE" ]]; then
  DART_DEFINES="$DART_DEFINES --dart-define=FIREBASE_API_KEY=$FIREBASE_API_KEY_VALUE"
  DART_DEFINES="$DART_DEFINES --dart-define=FIREBASE_APP_ID=$FIREBASE_APP_ID_VALUE"
  DART_DEFINES="$DART_DEFINES --dart-define=FIREBASE_MESSAGING_SENDER_ID=$FIREBASE_MESSAGING_SENDER_ID_VALUE"
  DART_DEFINES="$DART_DEFINES --dart-define=FIREBASE_PROJECT_ID=$FIREBASE_PROJECT_ID_VALUE"
  DART_DEFINES="$DART_DEFINES --dart-define=FIREBASE_AUTH_DOMAIN=$FIREBASE_AUTH_DOMAIN_VALUE"
fi
