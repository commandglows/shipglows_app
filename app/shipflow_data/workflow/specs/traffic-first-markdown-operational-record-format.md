...
owner: "Diane"
confidence: medium
user_story: "En tant qu'opératrice ShipFlow, je veux que les tâches, audits et specs utilisent des lignes Markdown traffic-first avec le projet visible au début, afin que les fichiers bruts, le TUI et la future application web lisent les mêmes signaux opérationnels sans normalisation divergente."
risk_level: "high"
security_impact: "yes"
docs_impact: "yes"
linked_systems:
  - "ShipFlow Markdown trackers"
...
depends_on:
  ...
  - artifact: "shipflow_data/technical/code-docs-map.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "/home/claude/shipflow/shipflow_data/workflow/specs/shipflow-terminal-tui-v1.md"
    artifact_version: "0.1.0"
...
evidence:
  ...
  - "lib/data/shipflow_sources/parsers/tasks_parser.dart currently derives task state from project sections and table/status text."
...
- System effect: Flutter readers, TUI readers, tests, docs, and ShipFlow writer protocols agree on one canonical operational record grammar while preserving legacy table compatibility during migration.
...
- User/operator response: Readers emit source diagnostics with file, line, excerpt, and suggested ShipFlow command instead of silently dropping the entire file.
...
ShipFlow Markdown files are the canonical operational source, but current task and audit trackers rely heavily on wide tables and project sections. The TUI has started converting those tables into readable traffic-first display lines, yet the raw Markdown still varies by file and workflow. This makes the source harder to scan, forces each app surface to repeat normalization logic, and allows writer skills to keep creating divergent formats.
...
Define a canonical traffic-first operational record line format for tasks, audits, and spec summary/index records. Update project docs, shared ShipFlow writer-skill references, Flutter parsers, TUI readers, tests, and migration tooling so new records are created correctly at the source while old tables remain readable during a controlled compatibility period.
...
- Update `shipflow_data/technical/markdown-source-of-truth.md` with grammar, field rules, examples, diagnostics, and compatibility policy.
- Update `shipflow_data/technical/code-docs-map.md` with parser and writer update triggers if ownership changes.
- Add a shared ShipFlow-owned reference for writer skills, for example `/home/claude/shipflow/skills/references/operational-record-format.md`.
...
- Update Flutter source parsers under `lib/data/shipflow_sources/parsers/` to parse traffic-first records before falling back to legacy tables.
...
- Runtime:
  - Flutter/Dart parsers in `lib/data/shipflow_sources/parsers/`.
  - TUI TypeScript readers in `tui/src/sources/`.
  - ShipFlow-owned skills and references under `/home/claude/shipflow/skills/`.
  - Global trackers under `/home/claude/shipflow_data/`.
- Document contracts:
  - `explorations/2026-05-22-markdown-operational-record-format.md@1.0.0`.
  - `shipflow_data/technical/markdown-source-of-truth.md@0.1.0`.
  - `shipflow_data/technical/code-docs-map.md@0.1.0`.
  - `/home/claude/shipflow/shipflow_data/workflow/specs/shipflow-terminal-tui-v1.md@0.1.0`.
- Metadata gaps:
  ...
  - Some existing ShipFlow writer skills may encode tracker write rules only in prose; readiness must identify the exact skills to patch.
- Fresh external docs: not needed. This spec changes local Markdown conventions, local parsers, local tests, and local ShipFlow skill instructions; it does not depend on external SDK, framework, API, auth, build, routing, or service behavior.
...
- Update `shipflow_data/technical/markdown-source-of-truth.md` with the operational record grammar, examples, required fields, legacy compatibility, diagnostics, and migration policy.
- Update `shipflow_data/technical/code-docs-map.md` if parser ownership, validation commands, or update triggers change.
- Update `shipflow_data/technical/terminal-tui.md` so the TUI docs describe canonical record parsing instead of display-only normalization.
- Add `/home/claude/shipflow/skills/references/operational-record-format.md` as the shared writer contract for skills.
...
- [ ] Task 1: Create the shared operational record contract.
  - File: `/home/claude/shipflow/skills/references/operational-record-format.md`
  ...
  - Validate with: `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py /home/claude/shipflow/skills/references/operational-record-format.md`
...
- [ ] Task 2: Update project source-of-truth docs.
  ...
  - Depends on: Task 1.
  - Validate with: `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/technical/markdown-source-of-truth.md`
...
- [ ] Task 3: Update documentation ownership map.
  ...
  - Depends on: Task 2.
  - Validate with: `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/technical/code-docs-map.md`
  - Notes: Mention the shared ShipFlow-owned reference by absolute path because it lives outside the project repo.

- [ ] Task 4: Add Flutter operational record parser primitives.
  - File: `lib/data/shipflow_sources/parsers/operational_record_parser.dart`
...
- [ ] Task 5: Extend parsed models for canonical records.
  - File: `lib/data/shipflow_sources/parsers/parsed_models.dart`
...
- [ ] Task 6: Update task parsing with canonical-first fallback.
  - File: `lib/data/shipflow_sources/parsers/tasks_parser.dart`
...
- [ ] Task 7: Update audit parsing with canonical-first fallback.
  - File: `lib/data/shipflow_sources/parsers/audit_log_parser.dart`
...
- [ ] Task 8: Update spec parsing for operational summaries.
  - File: `lib/data/shipflow_sources/parsers/specs_parser.dart`
...
- [ ] Task 12: Update writer skills to use the shared format.
  - File: `/home/claude/shipflow/skills/sf-tasks/SKILL.md`
  ...
  - Depends on: Task 1.
  - Validate with: `rg -n "operational-record-format|TASKS.md|task:" /home/claude/shipflow/skills/sf-tasks/SKILL.md`
...
- [ ] Task 13: Update audit writer skills to use the shared format.
  - File: `/home/claude/shipflow/skills/sf-audit/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-a11y/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-code/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-components/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-copy/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-copywriting/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-design/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-design-tokens/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-gtm/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-seo/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-audit-translate/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-deps/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-perf/SKILL.md`
  ...
  - Depends on: Task 1.
  - Validate with: `rg -n "operational-record-format|AUDIT_LOG.md|audit:" /home/claude/shipflow/skills/sf-audit/SKILL.md /home/claude/shipflow/skills/sf-audit-a11y/SKILL.md /home/claude/shipflow/skills/sf-audit-code/SKILL.md /home/claude/shipflow/skills/sf-audit-components/SKILL.md /home/claude/shipflow/skills/sf-audit-copy/SKILL.md /home/claude/shipflow/skills/sf-audit-copywriting/SKILL.md /home/claude/shipflow/skills/sf-audit-design/SKILL.md /home/claude/shipflow/skills/sf-audit-design-tokens/SKILL.md /home/claude/shipflow/skills/sf-audit-gtm/SKILL.md /home/claude/shipflow/skills/sf-audit-seo/SKILL.md /home/claude/shipflow/skills/sf-audit-translate/SKILL.md /home/claude/shipflow/skills/sf-deps/SKILL.md /home/claude/shipflow/skills/sf-perf/SKILL.md`
...
- [ ] Task 14: Update lifecycle/spec writer skills for spec operational summaries.
  - File: `/home/claude/shipflow/skills/sf-spec/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-ready/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-start/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-verify/SKILL.md`
  - File: `/home/claude/shipflow/skills/sf-end/SKILL.md`
  ...
  - Depends on: Task 1.
  - Validate with: `rg -n "operational-record-format|spec:" /home/claude/shipflow/skills/sf-spec/SKILL.md /home/claude/shipflow/skills/sf-ready/SKILL.md /home/claude/shipflow/skills/sf-start/SKILL.md /home/claude/shipflow/skills/sf-verify/SKILL.md /home/claude/shipflow/skills/sf-end/SKILL.md`
...
- [ ] Task 16: Migrate active Markdown sources after compatibility is proven.
  ...
  - File: `shipflow_data/workflow/AUDIT_LOG.md`
  - File: `shipflow_data/workflow/specs/*.md`
  - File: `/home/claude/shipflow_data/TASKS.md`
  - File: `/home/claude/shipflow_data/AUDIT_LOG.md`
  ...
  - Depends on: Task 15.
  - Validate with: `flutter test test/data/shipflow_sources && cd tui && bun test && bun run typecheck`
...
- [ ] Task 17: Run final coherence validation.
  - File: `shipflow_data/workflow/specs/traffic-first-markdown-operational-record-format.md`
  ...
  - Validate with: `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/technical/markdown-source-of-truth.md shipflow_data/technical/code-docs-map.md shipflow_data/workflow/specs/traffic-first-markdown-operational-record-format.md && flutter test test/data/shipflow_sources && cd tui && bun test && bun run typecheck`
  - Notes: This spec should then move to `/sf-verify` before closure.

## Acceptance Criteria

- [ ] AC 1: Given a task record such as `🔴 [shipflow_app] task: Run /sf-verify | status: todo`, when Flutter and TUI readers parse it, then both expose traffic `🔴`, project `shipflow_app`, kind `task`, title `Run /sf-verify`, and status `todo`.
...
- Unit:
  - `flutter test test/data/shipflow_sources` for Dart parser primitives, task parser, audit parser, spec parser, diagnostics, and legacy fallback.
...
- Manual:
  ...
  - Use the TUI project filter to inspect tasks, audits, and specs for at least `shipflow_app` and one global project.
...
- Workflow risk: high, because several skills may continue writing old tables if only the app parsers are updated. Mitigate by creating a shared ShipFlow-owned reference and updating writer skills before migrating live files.
...
- Read first:
  ...
  - `lib/data/shipflow_sources/parsers/tasks_parser.dart`
  - `lib/data/shipflow_sources/parsers/audit_log_parser.dart`
  - `lib/data/shipflow_sources/parsers/specs_parser.dart`
  - `tui/src/sources/readers.ts`
  - `/home/claude/shipflow/skills/references/operational-record-format.md` once created
...
- Validate with:
  - `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/workflow/specs/traffic-first-markdown-operational-record-format.md`
  - `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/technical/markdown-source-of-truth.md shipflow_data/technical/code-docs-map.md`
...
- Stop conditions:
  ...
  - Any writer outside `/home/claude/shipflow/skills` is still emitting legacy tracker format after the shared contract is introduced.
