...
docs_impact: yes
linked_systems:
  - "shipflow_data/workflow/specs/traffic-first-operational-record-live-migration-web-reader-contract.md"
  ...
  - "lib/data/shipflow_sources/parsers/operational_record_parser.dart"
  - "scripts/migrate_operational_records.py"
  - "/home/claude/shipflow/tui"
depends_on:
  - artifact: "shipflow_data/workflow/specs/traffic-first-operational-record-live-migration-web-reader-contract.md"
    artifact_version: "1.0.0"
...
evidence:
  ...
  - "cd /home/claude/shipflow/tui && bun test && bun run typecheck"
...
| --- | --- | --- |
| OR-WEB-001 | pass | `shipflow_data/technical/operational-record-web-reader-contract.md` defines `recordKind`, `sourcePath`, `line`, `rawLine`, `dedupeKey`, sort/filter and redaction rules. |
| OR-WEB-002 | pass | `test/data/shipflow_sources/fixtures/operational_records_web_reader.md` includes task/audit/spec rows, escaped title, duplicate case, project split, malformed diagnostic case. |
| OR-PARSE-001 | pass | `flutter test test/data/shipflow_sources` + `test/data/shipflow_sources/parsers/operational_record_parser_test.dart` assertions include project/traffic/fields/line/rawLine/dedupe and malformed fallback. |
| OR-TUI-001 | pass | `cd /home/claude/shipflow/tui && bun test && bun run typecheck` succeeded (existing TUI readers still canonical-first, and duplicate suppression is covered). |
...
- `python3 scripts/migrate_operational_records.py --write` ✅
- `flutter test test/data/shipflow_sources` ✅
- `cd /home/claude/shipflow/tui && bun test` ✅
- `cd /home/claude/shipflow/tui && bun run typecheck` ✅
- `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/technical/markdown-source-of-truth.md shipflow_data/technical/code-docs-map.md shipflow_data/technical/operational-record-web-reader-contract.md /home/claude/shipflow/skills/references/operational-record-format.md` ✅
- `git diff --check` ✅
