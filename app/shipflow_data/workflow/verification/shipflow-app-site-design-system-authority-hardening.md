...
scope: "shipflow-app-site-design-system-authority-hardening"
owner: "Diane"
confidence: medium
risk_level: high
...
linked_systems:
  ...
  - "shipflow_data/workflow/specs/shipflow-app-site-design-system-authority-hardening.md"
...
depends_on:
  ...
  - artifact: "shipflow_data/workflow/specs/shipflow-app-site-design-system-authority-hardening.md"
    artifact_version: "1.0.0"
    required_status: draft
supersedes: []
...
next_step: "/sf-verify shipflow_app app-site design-system authority hardening"
---

# Verification: shipflow_app – App & Site Design-System Authority Hardening
...
python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py \
  shipflow_data/technical/design-system-authority.md \
  shipflow_data/workflow/specs/shipflow-app-site-design-system-authority-hardening.md \
  shipflow_data/workflow/verification/shipflow-app-site-design-system-authority-hardening.md

python3 /home/claude/shipflow/tools/design_system_drift_check.py --root /home/claude/shipflow_app --changed --warn-only

rg -n "design_system_authority|design-system-authority|shipflow-app-site-design-system-authority-hardening" \
  shipflow_data/technical/design-system-authority.md \
  shipflow_data/workflow/specs/shipflow-app-site-design-system-authority-hardening.md \
  shipflow_data/workflow/verification/shipflow-app-site-design-system-authority-hardening.md
```
