...
import '../../data/shipflow_sources/parsers/shipflow_sources_parser.dart';
import '../../data/shipflow_sources/source_file_reader.dart';
import '../../data/shipflow_sources/source_path_policy.dart';
...
final shipflowSourcesParserProvider = Provider<ShipFlowSourcesParser>(
  (ref) => ShipFlowSourcesParser(),
);
...
class DashboardNotifier extends AsyncNotifier<DashboardModel> {
  ...
  Future<DashboardModel> _load() async {
    ...
    final parser = ref.read(shipflowSourcesParserProvider);
