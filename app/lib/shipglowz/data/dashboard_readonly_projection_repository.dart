...
class InMemoryDashboardReadonlyProjectionRepository
  ...
  InMemoryDashboardReadonlyProjectionRepository({
    ...
    required Map<String, ShipGlowzProjectRecord> projects,
  ...
  final Map<String, ShipGlowzProjectRecord> _projects;
  ...
  DashboardProjectViewState _viewStateFor(
    ShipGlowzProjectRecord project,
    int artifactCount,
    int diagnosticCount,
  ) {
  ...
  DashboardArtifactFamily _familyFor(IndexedFileRecord file) {
    ...
    if (path.startsWith('shipglowz_data/business/')) {
      return DashboardArtifactFamily.business;
    }
    if (path.startsWith('shipglowz_data/technical/')) {
      return DashboardArtifactFamily.technical;
    }
    if (path.startsWith('shipglowz_data/editorial/')) {
      return DashboardArtifactFamily.editorial;
    }
    if (path.startsWith('shipglowz_data/workflow/specs/')) {
      return DashboardArtifactFamily.spec;
    }
    if (path.startsWith('shipglowz_data/workflow/bugs/')) {
      return DashboardArtifactFamily.bug;
    }
    if (path.startsWith('shipglowz_data/workflow/')) {
