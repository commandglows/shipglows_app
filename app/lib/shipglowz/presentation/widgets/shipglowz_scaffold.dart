...
class _ShipGlowzNavItem {
  const _ShipGlowzNavItem({
    required this.label,
    required this.path,
    required this.icon,
  });
...
class ShipGlowzScaffold extends StatelessWidget {
  const ShipGlowzScaffold({
    required this.title,
    required this.body,
    this.actions = const [],
    super.key,
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              children: [
                ...
                const Expanded(child: ShipGlowzSettingsPanel(compact: true)),
              ],
            ),
          ),
        ),
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (context) => SafeArea(
        child: SizedBox(
          ...
          child: const ShipGlowzSettingsPanel(compact: true),
        ),
      ),
    );
  }
