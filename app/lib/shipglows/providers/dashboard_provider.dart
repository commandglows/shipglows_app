...
import '../../data/shipglows_sources/source_file_reader.dart';
import '../../data/shipglows_sources/source_path_policy.dart';
...
final shipglowsSourcesParserProvider = Provider<ShipGlowsSourcesParser>(
  (ref) => ShipGlowsSourcesParser(),
);
...
class DashboardNotifier extends AsyncNotifier<DashboardModel> {
  ...
  Future<DashboardModel> _load() async {
    ...
    final parser = ref.read(shipglowsSourcesParserProvider);
