...
import 'shipflow_artifact_index_policy.dart';
...
class LocalFakeCloneIndexer {
  LocalFakeCloneIndexer({
    ...
    ShipFlowArtifactIndexPolicy? artifactPolicy,
    DateTime Function()? clock,
  }) : artifactPolicy = artifactPolicy ?? const ShipFlowArtifactIndexPolicy(),
       _clock = clock ?? (() => DateTime.now().toUtc());

  final SourcePathPolicy pathPolicy;
  final ShipFlowArtifactIndexPolicy artifactPolicy;
