...
import 'shipglows_artifact_index_policy.dart';
...
class LocalFakeCloneIndexer {
  LocalFakeCloneIndexer({
    ...
    ShipGlowsArtifactIndexPolicy? artifactPolicy,
    DateTime Function()? clock,
  }) : artifactPolicy = artifactPolicy ?? const ShipGlowsArtifactIndexPolicy(),
       _clock = clock ?? (() => DateTime.now().toUtc());

  final SourcePathPolicy pathPolicy;
  final ShipGlowsArtifactIndexPolicy artifactPolicy;
