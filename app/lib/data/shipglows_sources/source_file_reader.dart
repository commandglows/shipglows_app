...
class SourceFileReader {
  SourceFileReader({
    ...
    this.shipglowsDataRoot = '/home/claude/shipglows_data',
    this.shipglowsRoot = '/home/claude/shipglows',
  });

  final SourcePathPolicy pathPolicy;
  final String shipglowsDataRoot;
  final String shipglowsRoot;
  ...
  Future<SourceSnapshot> load() async {
    ...
    final baseSources = <String>[
      '$shipglowsDataRoot/PROJECTS.md',
      '$shipglowsDataRoot/AUDIT_LOG.md',
      '$shipglowsDataRoot/TASKS.md',
      '$shipglowsDataRoot/OPERATIONS_LOG.md',
      '$shipglowsDataRoot/DEPENDENCY_LOG.md',
    ];
    ...
    final specsDirectory = Directory(
      '$shipglowsRoot/shipglows_data/workflow/specs',
    );
      ...
      if (totalBytes >= pathPolicy.maxTotalBytes) {
        diagnostics.add(
          SourceDiagnostic(
            ...
            suggestedCommand: '/sf-verify ShipGlows source inventory',
          ),
        );
        break;
      }
