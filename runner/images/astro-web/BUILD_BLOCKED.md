...
This temporary proof branch contains a Dockerfile with immutable toolchain
inputs. It is a build candidate only: it remains non-routable until the remote
workflow records the private VCR repository, final digest, offline-store proof,
SBOM, provenance, vulnerability result, and retirement time.
