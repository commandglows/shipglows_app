s raison. Les skills doivent être technologies-agnostiques par défaut.
 ...
 ShipGlows = règles Flutter                                                                                                                                                                                           mais:                                                                                                                                                                                                               ShipGlows = règles de preuve génériques
  ...
  unit/component tests si présents                                                                          Playwright smoke via sg-browser                                                                           SEO/a11y checks                                                                                           manual checklist seulement pour review éditoriale ou rendu subjectif
  Pour Python:
