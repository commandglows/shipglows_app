...
summary: "The single public design entrypoint for system creation, animation, playgrounds, UI/token/component/accessibility audits, implementation, proof, verification, and shipping."
category: "Build & Fix"
audience:
...
outcome: "You get the right design route: audit, token creation, animation, playground, component or accessibility review, spec-first implementation, browser proof, verification, and ship routing when the work is ready."
...
example_prompts:
  ...
  - "/006-sg-design animation audit src/pages"
  - "/006-sg-design animation design homepage"
...
argument_modes:
  ...
  - argument: "animation <audit|design|implement|tune> [scope]"
    effect: "Audits, designs, implements, or tunes a coherent motion system with reduced-motion, responsive, lifecycle, and browser-proof gates."
    consequence: "GSAP is optional after project fit; it is not a separate public command or an implicit dependency."
