...
argument_modes:
  - argument: "capture"
    ...
    consequence: "Uses the internal capture implementation; `tmux` and legacy `capture-full-conversation` are aliases, and the mode does not clean, summarize, or repurpose the transcript."
