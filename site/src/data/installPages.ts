...
export const installPages: Record<"shipglows" | "dotfiles", Record<Locale, InstallPageContent>> = {
  shipglows: {
    en: { slug: "shipglows", kicker: "Local or server setup", title: "Install the right ShipGlows layer for this machine.", description: "Set up local tunnels, a complete Ubuntu server, or a native Windows development environment for Astro, Python and Flutter for web, Android, and Windows. On Android Termux, a first password pairing can promote to a device-specific SSH key for later tunnels.", fitTitle: "Best for", fit: ["native Windows development without WSL, including Flutter Android and Windows desktop", "Ubuntu project servers", "Termux and local tunnel clients"], installedTitle: "What full Windows prepares", installed: ["Git, GitHub CLI, Node LTS, npm, pnpm, uv and a default Python runtime", "Flutter and Dart with the Android SDK and visible official license acceptance", "an optional Android emulator, plus Android Studio and Visual Studio Community C++ when missing", "PowerShell-safe commands and MCP preparation for already installed coding agents", "a durable environment report with separate readiness states and the exact next action"], limitsTitle: "Important boundaries", limits: ["Ubuntu full requires root; Windows full installs in the user profile", "The emulator needs hardware acceleration; otherwise use a real phone or Firebase Device Streaming", "Firebase Device Streaming requires your own sign-in, project, billing and device reservation in Android Studio", "Large IDE installs require confirmation; ShipGlows does not restart Windows or authenticate GitHub, coding agents or Firebase"], copyLabel: "Copy command", copiedLabel: "Copied", rawLabel: "Open raw script", repositoryLabel: "ShipGlows repository", repositoryUrl: "https://github.com/commandglows/shipglows", rawUrl: "/shipglows-script", variants: shipglowsVariants(false) },
    fr: { slug: "shipglows", kicker: "Setup local ou serveur", title: "Installez la bonne couche ShipGlows pour cette machine.", description: "Configurez les tunnels locaux, un serveur Ubuntu complet ou un environnement de développement Windows natif pour Astro, Python et Flutter pour le Web, Android et Windows. Sur Android Termux, le premier appairage par mot de passe peut passer à une clé SSH propre à l’appareil pour les tunnels suivants.", fitTitle: "Idéal pour", fit: ["développement Windows natif sans WSL, y compris Flutter Android et Windows desktop", "serveurs de projets Ubuntu", "Termux et clients de tunnels locaux"], installedTitle: "Ce que Windows full prépare", installed: ["Git, GitHub CLI, Node LTS, npm, pnpm, uv et un runtime Python par défaut", "Flutter et Dart avec le SDK Android et l’acceptation visible des licences officielles", "un émulateur Android optionnel, plus Android Studio et Visual Studio Community C++ lorsqu’ils manquent", "des commandes compatibles PowerShell et la préparation MCP des agents déjà installés", "un rapport d’environnement durable avec des états séparés et la prochaine action exacte"], limitsTitle: "Limites importantes", limits: ["Ubuntu full exige root ; Windows full s’installe dans le profil utilisateur", "L’émulateur nécessite l’accélération matérielle ; sinon utilisez un téléphone réel ou Firebase Device Streaming", "Firebase Device Streaming exige votre propre connexion, projet, facturation et réservation d’appareil dans Android Studio", "Les IDE volumineux demandent une confirmation ; ShipGlows ne redémarre pas Windows et n’authentifie ni GitHub, ni les agents, ni Firebase"], copyLabel: "Copier la commande", copiedLabel: "Copié", rawLabel: "Ouvrir le script brut", repositoryLabel: "Dépôt ShipGlows", repositoryUrl: "https://github.com/commandglows/shipglows", rawUrl: "/shipglows-script", variants: shipglowsVariants(true) },
  },
  dotfiles: {
