...
```json
{
  ...
  "path": "specs/shipflow-firestore-data-model.md",
  "artifactType": "spec",
  "sourceCommit": "abc123",
  "contentHash": "sha256:...",
...
```json
{
  ...
  "redactedPath": "specs/large-file.md"
}
```
...
```bash
rg -n "users/\\{uid\\}|projects/\\{projectId\\}|indexedFiles|indexRuns|diagnostics|projectRefs|feedItems" docs/technical/firestore-data-model.md
flutter test test/data/firestore_projection
rg -n "token|installation token|service credential|clone path|clone URL" docs/technical/firestore-data-model.md lib/data/firestore_projection test/data/firestore_projection
```
