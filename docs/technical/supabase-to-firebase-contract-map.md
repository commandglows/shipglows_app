...
docs_impact: yes
linked_systems:
  - "backup/local-supabase-wip-2026-05-08:specs/full-supabase-migration.md"
  - "Firebase Auth"
  - "Cloud Firestore"
  ...
  - "local clones"
depends_on:
  - "specs/firebase-firestore-projection-migration.md@0.1.0"
...
next_step: "/sf-start ShipFlow Project Source Onboarding"
---
...
- `docs/technical/supabase-to-firebase-contract-map.md`
