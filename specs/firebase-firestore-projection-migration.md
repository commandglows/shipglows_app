...
depends_on:
  - artifact: "docs/technical/recovered-branch-reality.md"
  ...
  - artifact: "docs/technical/shipflow-foundational-architecture.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "https://firebase.google.com/docs/flutter/setup"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  - artifact: "https://firebase.google.com/docs/auth/flutter/start"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  - artifact: "https://firebase.google.com/docs/firestore"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  ...
  - artifact: "https://firebase.google.com/docs/functions"
    ...
    required_status: "active"
supersedes:
  - "backup/local-supabase-wip-2026-05-08:specs/full-supabase-migration.md as implementation target"
evidence:
...
- If Firebase docs or SDK behavior differ from assumptions, implementation stops and updates this spec.
...
- Update docs to record translation decisions.
...
- Official Firebase Flutter setup docs checked 2026-05-09: `https://firebase.google.com/docs/flutter/setup`.
- Official Firebase Auth Flutter docs checked 2026-05-09: `https://firebase.google.com/docs/auth/flutter/start`.
- Official Cloud Firestore docs checked 2026-05-09: `https://firebase.google.com/docs/firestore`.
- Official Firestore Security Rules docs checked 2026-05-09: `https://firebase.google.com/docs/firestore/security/get-started`.
- Official Cloud Functions for Firebase docs checked 2026-05-09: `https://firebase.google.com/docs/functions`.
- Local evidence: `backup/local-supabase-wip-2026-05-08:specs/full-supabase-migration.md`.
...
- `specs/shipflow-project-source-onboarding.md` becomes the immediate feature spec that consumes this architecture.
- `docs/technical/recovered-branch-reality.md` remains the durable memory for branch and WIP context.
- `docs/technical/markdown-source-of-truth.md` must mention Firestore as projection once implementation starts.
- Future Firebase implementation must update `pubspec.yaml`, app init, auth/session providers, projection repositories, and docs.
...
- Keep `docs/technical/recovered-branch-reality.md` as source for branch reality.
- Future implementation docs must distinguish `GitHub canonical`, `local clone working copy`, and `Firestore projection`.
...
1. Create a Supabase-to-Firebase contract extraction document under `docs/technical/`.
...
6. Update `docs/technical/recovered-branch-reality.md` with recovered contract checklist.
7. Update `specs/shipflow-project-source-onboarding.md` to consume Firebase/Firestore architecture.
...
- Documentation validation:
  - `rg -n "Supabase|Firebase|Firestore|Cloud Functions|GitHub repository|local clone" specs docs/technical README.md`
  - `rg -n "recovered-branch-reality|firebase-firestore-projection-migration" CONTENT_MAP.md docs/technical specs`
...
- Fresh external docs checked from official Firebase docs on 2026-05-09.
...
| 2026-05-09 13:00:00 UTC | sf-start | GPT-5 Codex | implemented | Added `docs/technical/supabase-to-firebase-contract-map.md`. |
...
| Step | Status | Notes |
| --- | --- | --- |
| sf-spec | done | Spec created in `specs/firebase-firestore-projection-migration.md`. |
| sf-ready | ready | Ready for documentation extraction slice. |
| governance corpus gate | already existed | `docs/technical/`, `docs/technical/code-docs-map.md`, and `CONTENT_MAP.md` exist. |
| sf-start | implemented | Extraction doc created in `docs/technical/supabase-to-firebase-contract-map.md`. |
