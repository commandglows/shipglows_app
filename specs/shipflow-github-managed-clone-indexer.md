...
depends_on:
  ...
  - artifact: "https://docs.github.com/en/apps/creating-github-apps/authenticating-with-a-github-app/authenticating-as-a-github-app-installation"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  - artifact: "https://docs.github.com/en/rest/repos/repos"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  - artifact: "https://docs.github.com/en/rest/repos/contents"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
  - artifact: "https://docs.github.com/en/rest/git/trees"
    artifact_version: "checked-2026-05-09"
    required_status: "active"
supersedes: []
evidence:
...
- Update docs maps so future implementation agents know this spec owns the runner/indexer slice.
...
- Fresh official Firebase docs checked 2026-05-09: Cloud Functions, Cloud Firestore, and Firestore Security Rules.
- Fresh official GitHub docs checked 2026-05-09: repository API, contents API, Git trees API, and GitHub App installation authentication.
...
- Foundational architecture contract is `docs/technical/shipflow-foundational-architecture.md`.
- Firebase translation contract is `specs/firebase-firestore-projection-migration.md`.
...
- Keep `docs/technical/shipflow-foundational-architecture.md` as the canonical decision record.
...
1. Create Firestore contract docs for `users/{uid}`, `projects/{projectId}`, `projects/{projectId}/indexedFiles/{fileId}`, `projects/{projectId}/indexRuns/{runId}`, and `projects/{projectId}/diagnostics/{diagnosticId}`.
...
4. Define a runner interface in code or docs with `registerRepository`, `verifyGitHubAccess`, `indexRepository`, `getIndexStatus`, and `refreshRepositoryProjection`.
...
10. Update `CONTENT_MAP.md`, `docs/technical/code-docs-map.md`, and `docs/technical/shipflow-foundational-architecture.md` links after implementation starts.
...
- Fresh-docs verdict: checked. Official Firebase and GitHub docs support the boundary used here; implementation must re-check docs before adding real SDK/API code.
...
| Step | Status | Notes |
|------|--------|-------|
| sf-spec | done | Spec created from user architecture decisions and official Firebase/GitHub docs. |
...
| sf-verify | pending | Verify behavior, tests, and docs after implementation. |
| sf-end | pending | Close task and update trackers/docs. |
