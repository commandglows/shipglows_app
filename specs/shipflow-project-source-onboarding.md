...
depends_on:
  ...
  - artifact: "docs/technical/shipflow-legacy-reuse-roadmap.md"
    artifact_version: "0.1.0"
    required_status: "draft"
...
evidence:
  ...
  - "Local branch backup/local-supabase-wip-2026-05-08 contains unpushed Supabase migration WIP, including specs/full-supabase-migration.md and Supabase service/migration files."
...
- Fresh external docs: not needed because this spec does not implement external providers.
...
- Docs: update `docs/technical/markdown-source-of-truth.md`, `docs/technical/code-docs-map.md`, and `README.md`.

# Documentation Coherence

- `docs/technical/shipflow-legacy-reuse-roadmap.md` should mark project/source onboarding as first active reuse chantier.
- `docs/technical/markdown-source-of-truth.md` should describe source registration if implementation proceeds.
- `CONTENT_MAP.md` should add any new source registry or UI surface.
...
| Step | Status | Notes |
| --- | --- | --- |
| sf-spec | done | Draft created in `specs/shipflow-project-source-onboarding.md`. |
| sf-ready | ready | Project identity and V1 storage direction are decided. |
| governance corpus gate | already existed | `docs/technical/` and `CONTENT_MAP.md` exist. |
