...
## Proof points (supported in code/shipflow_data)
...
- **"Can I publish everywhere today?"**
  - Partial answer: publish-related screens and settings exist, but the complete account-mapping and external publish feedback loop is still marked incomplete in current shipflow_data/workflow/specs.
...
- **"Can this break existing channels?"**
  - Route and auth behavior are centralized; integration changes should be validated through shipflow_data/workflow/specs and shipflow_data before changes are promoted.
