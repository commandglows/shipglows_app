...
evidence:
  ...
  - "shipflow_data/workflow/specs/SPEC-project-flows-selection-onboarding-archive.md"
...
- Any change to onboarding, publish behavior, or offline coverage changes this product promise and must trigger shipflow_data updates for user-facing claims.
