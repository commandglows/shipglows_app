...
- Future sync/database shipflow_data/workflow/specs that project Markdown data
...
rg -n "service-role|SUPABASE|FIREBASE|Firestore|FastAPI|canonical|source of truth" lib shipflow_data/technical shipflow_data/workflow/specs README.md
```
