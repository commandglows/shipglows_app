...
docs_impact: "yes"
depends_on:
  - artifact: "shipflow_data/workflow/specs/SPEC-migrate-flutter-core-majors.md"
...
- `pubspec.lock`
- `pubspec.yaml`
- `shipflow_data/workflow/specs/PRD-lifetime-deal-early-bird-payg.md`
- `shipflow_data/workflow/specs/SPEC-content-pipeline-unification.md`
- `shipflow_data/workflow/specs/SPEC-offline-sync-v2.md`
- `shipflow_data/workflow/specs/architecture-cible-fastapi-clerk-flutter.md`
- `shipflow_data/workflow/specs/feedback-admin-v1-contentflow.md`
- `shipflow_data/workflow/specs/feedback-backend-contract-fastapi.md`
- `shipflow_data/workflow/specs/foundation-scrollable-nav-affiliations.md`
- `shipflow_data/workflow/specs/late-integration-finalization.md`
- `shipflow_data/workflow/specs/spec-no-ui-jump-on-resume.md`

Untracked files/directories observed:

- `.fvmrc`
- `.github/`
- `shipflow_data/workflow/specs/SPEC-migrate-flutter-core-majors.md`
...
- `shipflow_data/workflow/specs/SPEC-migrate-flutter-core-majors.md`
- `shipflow_data/workflow/specs/migrate-flutter-core-majors-baseline.md`
...
7. Full gate and shipflow_data:
   - Expected files: shipflow_data only after validation proves final package majors and Turso/no-backend conclusion.
