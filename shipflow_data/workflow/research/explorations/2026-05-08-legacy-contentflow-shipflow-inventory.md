...
evidence:
  ...
  - "CLAUDE.md, AGENT.md, shipflow_data/workflow/TASKS.md and most shipflow_data/workflow/specs still describe ContentFlow, Clerk, FastAPI, feedback, OpenRouter and content pipeline work."
depends_on: []
supersedes: []
...
- `shipflow_data/workflow/TASKS.md`, `CLAUDE.md`, `AGENT.md`, `shipflow_data/workflow/specs/` - mostly legacy ContentFlow tracking and specs.
...
| `shipflow_data/workflow/specs/*contentflow*` and FastAPI shipflow_data/workflow/specs | ContentFlow | Not ShipFlow source of truth | Transfer/archive |
| `shipflow_data/workflow/TASKS.md`, `CLAUDE.md`, `AGENT.md` | ContentFlow | Actively misleading for ShipFlow | Rewrite for ShipFlow |

## Option Space

### Option A: Hard purge now

- Summary: Delete all legacy ContentFlow runtime and shipflow_data now.
...
- Cons: Keeps architecture confusion, stale tests, stale shipflow_data and misleading decisions.
- Verdict: Not enough.
...
9. Which entities are real ShipFlow entities: projects, tasks, shipflow_data/workflow/specs, audit events, operations, dependencies, content items, users, workspaces?
...
- Why this next step: The work crosses shipflow_data, runtime, tests, scripts and product decisions; it should not be executed as a casual cleanup.

## Exploration Run History

| Date UTC | Prompt/Focus | Action | Result | Next step |
|----------|--------------|--------|--------|-----------|
| 2026-05-08 | Inventory legacy ContentFlow before deleting anything | Read runtime, shipflow_data, routes, services, models and shipflow_data/workflow/specs; classified reusable bricks and decision questions | Staged extraction recommended | Answer direction questions, then create spec |
